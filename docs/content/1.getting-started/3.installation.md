...
- **Nuxt 3** project (version 3.0 or higher)
...
Test that everything is working by opening the Nuxt DevTools panel in your browser and navigating to the "Nuxt Email Renderer" tab. 

You should see your `WelcomeEmail` template listed.
...
1. Ensure you're using Nuxt 3.0 or higher
